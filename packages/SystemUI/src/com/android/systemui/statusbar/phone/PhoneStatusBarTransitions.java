...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mLeftSide, mStatusIcons, mSignalCluster, mBattery, mClock, mDEMENTEDLogo;
    ...
    public void init() {
        ...
        mDEMENTEDLogo = mView.findViewById(R.id.demented_logo);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    animateTransitionTo(mDEMENTEDLogo, newAlphaBC)
                    );
            if (isLightsOut(mode)) {
            ...
            mDEMENTEDLogo.setAlpha(newAlphaBC);
        }
    }
}
